...
## โครงการตัวอย่าง: สถานีตรวจสอบสภาพอากาศ IoT

สถานีตรวจสอบสภาพอากาศ IoT เป็นตัวอย่างโครงการที่รวมความรู้ที่เรียนมาทั้งหมดในบทนี้ โดยใช้ ESP8266/ESP32 อ่านค่าจากเซ็นเซอร์อุณหภูมิและความชื้น แล้วส่งข้อมูลผ่าน MQTT

### อุปกรณ์ที่ใช้

1. ESP8266 หรือ ESP32 บอร์ด
2. เซ็นเซอร์ DHT22/DHT11 (อุณหภูมิและความชื้น)
3. เซ็นเซอร์ BMP280 (ความกดอากาศ)
4. LDR (Light Dependent Resistor) สำหรับวัดความเข้มแสง
5. แบตเตอรี่ Li-ion 18650 และวงจรชาร์จ
6. แผงโซล่าเซลล์ขนาดเล็ก (ทางเลือก)

### วงจรการเชื่อมต่อ

```
ESP8266/ESP32    DHT22/DHT11       BMP280           LDR
-----------      -----------       ------           ---
3.3V       ----- VCC               VCC              
GND        ----- GND               GND              GND
D4 (GPIO4) ----- DATA
...
```cpp
// ดูโค้ดตัวอย่างเต็มได้ในไฟล์ examples/weather_station.ino
// โค้ดนี้จะมีการเชื่อมต่อ WiFi, MQTT และอ่านค่าจากเซ็นเซอร์ต่างๆ
// แล้วส่งข้อมูลไปยัง MQTT broker ในรูปแบบ JSON
```
