...
| รายละเอียด | คำอธิบาย |
|----------|---------|
| **ชื่อเนื้อหา** | ภาพรวมของเทคโนโลยี IoT |
| **วัตถุประสงค์** | เข้าใจหลักการพื้นฐานและองค์ประกอบของ IoT |
| **ระดับความยาก** | ง่าย [⭑] |
| **เวลา** | 30 นาที - 45 นาที |
| **ความรู้พื้นฐาน** | ไม่จำเป็นต้องมีความรู้พื้นฐานด้าน IoT |
